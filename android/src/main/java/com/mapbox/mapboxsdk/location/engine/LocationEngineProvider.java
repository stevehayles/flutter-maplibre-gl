...
public final class LocationEngineProvider {
     ...
     * @param background true if background optimized engine is desired (note:
     *                   parameter deprecated)
     * @return a unique instance of {@link LocationEngine} every time method is
     *         called.
     * @since 1.0.0
     */
    @NonNull
    ...
    public static LocationEngine getBestLocationEngine(@NonNull Context context) {
        ...
        if (isOnClasspath(GOOGLE_API_AVAILABILITY)) {
            ...
            hasGoogleLocationServices &= GoogleApiAvailability.getInstance()
